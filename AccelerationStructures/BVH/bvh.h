...
public:
	...
	void				Build();
	BBox				WorldBound() { return nodes ? nodes[0].bounds : BBox(); } 
	...
	size_t				GetSizeOfElement() { return sizeof(LinearBVHNode); }
	void*				GetPtrToElements() { return static_cast<void*>(nodes); }
	unsigned int*		GetOrderedElementsIds() { return orderedPrimitivesIds; }
	unsigned int		GetKeyboardId() { return 0;}
...
private:
	...
	LinearBVHNode		*nodes;
	unsigned int		*orderedPrimitivesIds;
};
